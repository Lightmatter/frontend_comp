...
ROOT_URLCONF = "frontend_comp.config.urls"
# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "frontend_comp.config.wsgi.application"
...
MIDDLEWARE = [
    ...
    "frontend_comp.util.middleware.HTMXMessageMiddleware",
    "frontend_comp.util.middleware.TimezoneMiddleware",
]
    ...
    },
    {
        ...
        "OPTIONS": {
            ...
            "builtins": [
                ...
                "frontend_comp.util.templatetags.filters",
...
ACCOUNT_ADAPTER = "frontend_comp.user.adapter.HTMXAccountAdapter"
ACCOUNT_TEMPLATE_EXTENSION = "jinja"


# https://django-allauth.readthedocs.io/en/latest/forms.html#account-forms
ACCOUNT_FORMS = {
    "login": "frontend_comp.user.forms.LoginForm",
    "signup": "frontend_comp.user.forms.SignupForm",
}
